...
import img1 from "../Images/imagencreando.png";
...
const Creando = () => {
  return (
    <motion.div
      ...
      className=" text-white py-12 px-6  md:px-20 flex flex-col-reverse md:flex-row items-center justify-between gap-12 rounded-3xl shadow-xl"
    >
      {/* Text Section */}
      <div className="max-w-lg w-full text-center md:text-left">
        ...
        <form className="flex flex-col sm:flex-row items-center sm:items-stretch gap-3 sm:gap-0 w-full">
          <button
            ...
            type="submit"
            className="px-6 py-3  text-white font-semibold rounded-md bg-purple-600 hover:bg-purple-700 transition w-full sm:w-auto mx-10"
          >
            Portafolio Mateo Castro
          </button>
      <Link
           to="/"
            className="px-6 py-3  text-white font-semibold rounded-md bg-purple-600 hover:bg-purple-700 transition w-full sm:w-auto inline-block text-center"
            >
              Ir a Inicio
        </Link>
        </form>
